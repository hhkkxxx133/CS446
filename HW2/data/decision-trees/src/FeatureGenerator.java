...
public class FeatureGenerator {
	...
	// generate 10 features for each example: the first five characters from the first and last name
	...
	/////////////////////////////
	int first_len = firstName.length();
	int last_len = lastName.length();
